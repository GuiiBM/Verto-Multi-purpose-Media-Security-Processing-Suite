...
def SUBTITLELAB_HUB_HTML(): return _load('subtitlelab_hub.html')
def SUBTITLELAB_EDITOR_HTML(): return _load('subtitlelab_editor.html')
def SUBTITLELAB_BURN_HTML(): return _load('subtitlelab_burn.html')
